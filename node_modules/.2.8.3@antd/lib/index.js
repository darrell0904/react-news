...
var ENV = process.env.NODE_ENV; // this file is not used if use https://github.com/ant-design/babel-plugin-import

if (ENV !== 'production' && ENV !== 'test') {
    (0, _warning2["default"])(false, 'You are using a whole package of antd,' + 'please use https://www.npmjs.com/package/babel-plugin-import to reduce app bundle size.');
}